...
""",
        'risk_description': {
            "HIGH_WARNING": """
<p>Уровень опасности, связанный с наличием медуз на пляжах, выражается индексом, который складывается из токсичности вида и его распространенности в зоне купания. В данном случае вид Pelagia noctiluca считается ОЧЕНЬ жгучим видом, но поскольку по своей распространенности он относится к категории %(abundance)i %(abundance_ratio)s, то уровень опасности в этот день на данном пляже считается равным 2 (Встречаются ОПАСНЫЕ медузы).</p>
""",
            "VERY_HIGH_WARNING": """
<p>Уровень опасности, связанный с наличием медуз на пляжах, выражается индексом, который складывается из токсичности вида и его распространенности в зоне купания. В данном случае вид Pelagia noctiluca считается ОЧЕНЬ жгучим видом, и поскольку по своей распространенности он относится к категории %(abundance)i %(abundance_ratio)s, то уровень опасности в этот день на данном пляже считается равным 3 (Встречаются ОЧЕНЬ ОПАСНЫЕ медузы).</p>
"""
            },
        },
    2: {
...
""",
        'risk_description': {
            "LOW_WARNING": """
<p>Уровень опасности, связанный с наличием медуз на пляжах, выражается индексом, который складывается из токсичности вида и его распространенности в зоне купания. В данном случае вид Rhizostoma pulmo считается ЖГУЧИМ видом, но поскольку по своей распространенности он относится к категории %(abundance)i %(abundance_ratio)s, то уровень опасности в этот день на данном пляже считается равным 1 (Встречаются БЕЗОПАСНЫЕ медузы).</p>
""",
            "HIGH_WARNING": """
...
""",
        'risk_description': {
            "HIGH_WARNING": """
<p>Уровень опасности, связанный с наличием медуз на пляжах, выражается индексом, который складывается из токсичности вида и его распространенности в зоне купания. В данном случае вид Chrysaora hysoscella считается ОЧЕНЬ жгучим видом, но поскольку по своей распространенности он относится к категории %(abundance)i %(abundance_ratio)s, то уровень опасности в этот день на данном пляже считается равным 2 (Встречаются ОПАСНЫЕ медузы).</p>
""",
            "VERY_HIGH_WARNING": """
...
""",
        'risk_description': {
            "HIGH_WARNING": """
<p>Уровень опасности, связанный с наличием медуз на пляжах, выражается индексом, который складывается из токсичности вида и его распространенности в зоне купания. В данном случае вид Carybdea marsupialis считается ОЧЕНЬ жгучим видом, но поскольку по своей распространенности он относится к категории %(abundance)i %(abundance_ratio)s, то уровень опасности в этот день на данном пляже считается равным 2 (Встречаются ОПАСНЫЕ медузы).</p>
""",
            "VERY_HIGH_WARNING": """
<p>Уровень опасности, связанный с наличием медуз на пляжах, выражается индексом, который складывается из токсичности вида и его распространенности в зоне купания. В данном случае вид Carybdea marsupialis считается ОЧЕНЬ жгучим видом; поскольку по своей распространенности он относится к категории %(abundance)i %(abundance_ratio)s, то уровень опасности в этот день на данном пляже считается равным 3 (Встречаются ОЧЕНЬ ОПАСНЫЕ медузы.</p>
""",
            },
        },
    10: {
...
""",
        'risk_description': {
            "HIGH_WARNING": """
<p>Уровень опасности, связанный с наличием медуз на пляжах, выражается индексом, который складывается из токсичности вида и его распространенности в зоне купания. В данном случае вид Olindias phosphorica считается ОЧЕНЬ жгучим видом, но поскольку по своей распространенности он относится к категории %(abundance)i %(abundance_ratio)s, то уровень опасности в этот день на данном пляже считается равным 2 (Встречаются ОПАСНЫЕ медузы).</p>
""",
            "VERY_HIGH_WARNING": """
