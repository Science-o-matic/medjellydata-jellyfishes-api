...
JELLYFISHES = {
    1: {
        ...
        'description': """
<p>Aquesta espècie és considerada una de les més abundants i importants al llarg de la costa catalana. És una espècie oceànica, per la qual cosa pot aparèixer en aigües costaneres depenent de les condicions ambientals i climatològiques. És molt freqüent la primavera i l’estiu, tot i que s'en poden detectar durant tot l'any.</p>
""",
        'risk_description': {
            "HIGH_WARNING": """
<p>El nivell de perillositat de la presència de meduses a les platges s'obté a través d'un índex que considera la capacitat urticant pròpia de l'espècie i l'abundància a les aigües de bany. En aquest cas, l'espècie Pelagia noctiluca és considerada una espècie MOLT urticant, però com que l'abundància és de categoria %(abundance)i %(abundance_ratio)s, el nivell de perillositat específic per aquest dia en aquesta platja és nivell 2 (Presència de Meduses AMB Perill).</p>
""",
            "VERY_HIGH_WARNING": """
...
""",
        'risk_description': {
            "LOW_WARNING": """
<p>El nivell de perillositat de la presència de meduses a les platges s'obté a través d'un índex que considera la capacitat urticant pròpia de l'espècie i l'abundància a les aigües de bany. En aquest cas, l'espècie Rhizostoma pulmo és considerada una espècie URTICANT, però a causa que la seva abundància és de categoria %(abundance)i %(abundance_ratio)s, el nivell de perillositat específic per a aquest dia en aquesta platja és de nivell 1 (Presència de Meduses SENSE Perill).</p>
""",
            "HIGH_WARNING": """
...
"""
    ...
    3: {
        ...
        'description': """
<p>Durant els últims anys s'ha convertit en una espècie freqüent a la costa catalana, i quan ocorre, ho fa en grans nombres. Aquesta espècie habita des d'aigües temperades a tropicals, en àrees costaneres i litorals, i es troba fins i tot de forma ocasional en mar obert.</p>
""",
        'risk_description': {
            "LOW_WARNING": """
<p>El nivell de perillositat de la presència de meduses a les platges s'obté a través d'un índex que considera la capacitat urticant pròpia de l'espècie i l'abundància a les aigües de bany. En el cas d’Aequorea forskalea en ser una espècie LLEUGERAMENT urticant, el nivell de perillositat és 1 (Presència de meduses SENSE perill) independent de l'abundància en la qual estigui present a la platja, ja que la presència no representa cap perill per als banyistes.</p>
""",
            },
        },
    4: {
        ...
        'description': """
<p>És una espècie endèmica del Mediterrani i és molt freqüent en la costa catalana. És una espècie costanera, amb preferència d'aigües més càlides. Els adults són més abundants a la fi de l'estiu i a principis de la tardor.</p>
""",
        'risk_description': {
            "LOW_WARNING": """
<p>El nivell de perillositat de la presència de meduses a les platges s'obté a través d'un índex que considera la capacitat urticant pròpia de l'espècie i l'abundància a les aigües de bany. En el cas de Cotylorhiza tuberculata en ser una espècie LLEUGERAMENT urticant, el nivell de perillositat és 1 (Presència de meduses SENSE perill) independentment de l'abundància en la qual estigui present a la platja, ja que la presència no representa cap perill per als banyistes.</p>
""",
            },
        },
    5: {
        ...
        'description': """
<p>Al llarg de la costa catalana, com en tot el Mediterrani, és una espècie molt freqüent especialment durant la primavera. Viu a l’interfase d’aigua/aire amb el flotador sobre l'aigua. Pot estar present en grans eixams aconseguint fins i tot diversos quilòmetres. Com que el seu moviment depèn totalment dels corrents i dels vents de superfície, poden ser portades a la línia de costa i trobar-se encallades a les platges.</p>
""",
        'risk_description': {
            "LOW_WARNING": """
<p>El nivell de perillositat de la presència de meduses a les platges s'obté a través d'un índex que considera la capacitat urticant pròpia de l'espècie i l'abundància a les aigües de bany. En el cas de Velella velella en ser una espècie LLEUGERAMENT urticant, el nivell de perillositat és 1 (Presència de meduses SENSE perill) independent de l'abundància en la qual estigui present a la platja, ja que la presència no representa cap perill per als banyistes.</p>
""",
            },
        },
    6: {
...
""",
        'risk_description': {
            "LOW_WARNING": """
<p>El nivell de perillositat de la presència de meduses a les platges s'obté a través d'un índex que considera la capacitat urticant pròpia de l'espècie i l'abundància a les aigües de bany. En el cas d’Aurelia aurita en ser una espècie LLEUGERAMENT urticant, el nivell de perillositat és 1 (Presència de meduses SENSE perill) independent de l'abundància en la qual estigui present a la platja, ja que la presència no representa cap perill per als banyistes.</p>
""",
            },
        },
    7: {
...
""",
        'risk_description': {
            "HIGH_WARNING": """
<p>El nivell de perillositat de la presència de meduses a les platges s'obté a través d'un índex que considera la capacitat urticant pròpia de l'espècie i l'abundància a les aigües de bany. En aquest cas, l'espècie Chrysaora hysoscella és considerada una espècie MOLT urticant, i com que l'abundància és de categoria %(abundance)i %(abundance_ratio)s, el nivell de perillositat específic per a aquest dia en aquesta platja és nivell 2 (Presència de Meduses AMB perill).</p>
""",
            "VERY_HIGH_WARNING": """
<p>El nivell de perillositat de la presència de meduses a les platges s'obté a través d'un índex que considera la capacitat urticant pròpia de l'espècie i l'abundància a les aigües de bany. En aquest cas, l'espècie Chrysaora hysoscella és considerada una espècie MOLT urticant, i degut a que la seva abundància és de categoria %(abundance)i %(abundance_ratio)s, el nivell de perillositat específic per a aquest dia en aquesta platja és nivell 3 (Presència de Meduses d’ALT perill).</p>
"""
...
""",
        'risk_description': {
            "LOW_WARNING": """
<p>El nivell de perillositat de la presència de meduses a les platges s'obté a través d'un índex que considera la capacitat urticant pròpia de l'espècie i l'abundància a les aigües de bany. En el cas de Porpita porpita en ser una espècie LLEUGERAMENT urticant, el nivell de perillositat és 1 (Presència de meduses SENSE perill) independent de l'abundància en la qual estigui present a la platja, ja que la presència no representa cap perill per als banyistes.</p>
""",
            },
        },
    9: {
...
<p> L'ambient preferit d'aquesta espècie sembla ser el substrat sorrenc i es localitza sobre el fons durant el dia desplaçant-se a la superfície durant la nit. Aquesta espècie està present en alta abundància en algunes àrees de la costa espanyola Mediterrània, però al llarg de la costa catalana és considerada molt rara, malgrat que la presència podria estar subestimada.</p>
""",
        'risk_description': {
            "HIGH_WARNING": """
<p>El nivell de perillositat de la presència de meduses a les platges s'obté a través d'un índex que considera la capacitat urticant pròpia de l'espècie i l'abundància a les aigües de bany. En aquest cas, l'espècie Carybdea marsupialis és considerada una espècie MOLT urticant, com que l'abundància és de categoria %(abundance)i %(abundance_ratio)s, el nivell de perillositat específic per a aquest dia en aquesta platja és nivell 2 (Presència de meduses AMB perill).</p>
""",
            "VERY_HIGH_WARNING": """
...
""",
    ...
    11: {
        ...
        'description': """
<p>La presència d'aquesta espècie al llarg de la costa catalana és esporàdica. Mai no s'observen bancs extensos però pot ser molt abundant localment. En anys recents, està sent molt abundant en la costa de Tunísia al Mediterrani, on causa problemes per a la indústria del turisme.</p>
""",
        'risk_description': {
            "HIGH_WARNING": """
<p>El nivell de perillositat de la presència de meduses a les platges s'obté a través d'un índex que considera la capacitat urticant pròpia de l'espècie i l'abundància a les aigües de bany. En aquest cas, l'espècie Olindias phosphorica és considerada una espècie MOLT urticant, però degut a que la seva abundància és de categoria %(abundance)i %(abundance_ratio)s, el nivell de perillositat específic per a aquest dia en aquesta platja és nivell 2 (Presència de meduses AMB perill).</p>
""",
            "VERY_HIGH_WARNING": """
<p>El nivell de perillositat de la presència de meduses a les platges s'obté a través d'un índex que considera la capacitat urticant pròpia de l'espècie i l'abundància a les aigües de bany. En aquest cas, l'espècie Olindias phosphorica és considerada una espècie MOLT urticant, i degut a que la seva abundància és de categoria %(abundance)i %(abundance_ratio)s, el nivell de perillositat específic per a aquest dia en aquesta platja és nivell 3 (Presència de Meduses d’ALT perill).</p>
"""
...
""",
        'risk_description': {
            "LOW_WARNING": """
<p>El nivell de perillositat de la presència de meduses a les platges s'obté a través d'un índex que considera la capacitat urticant pròpia de l'espècie i l'abundància a les aigües de bany. En el cas de Mnemiopsis leidyi en ser una espècie NO urticant, el nivell de perillositat és 1 (presència de meduses SENSE perill) independent de l'abundància en la qual estigui present a la platja, ja que la presència no representa cap perill per als banyistes.</p>
""",
            },
        },
    13: {
...
""",
        'risk_description': {
            "LOW_WARNING": """
<p>El nivell de perillositat de la presència de meduses a les platges s'obté a través d'un índex que considera la capacitat urticant pròpia de l'espècie i l'abundància a les aigües de bany. En el cas de Phyllorhiza punctata, en ser una espècie LLEUGERAMENT urticant, el nivell de perillositat és 1 (presència de meduses SENSE perill) independent de l'abundància en la qual estigui present a la platja, ja que la presència no representa cap perill per als banyistes.</p>
""",
            },
        },
    }
